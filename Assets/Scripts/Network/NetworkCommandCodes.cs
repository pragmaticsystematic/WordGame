namespace Network
{
    namespace NetworkCodes
    {
        ...
        {
            public const char LETTER_DOESNT_EXIST_IN_WORD                = '0';
            public const char LETTER_EXISTS_IN_WORD_BUT_NOT_IN_ORDER     = '1';
            public const char LETTER_EXISTS_IN_WORD_AND_IN_CORRECT_PLACE = '2';
            public const char SOMETHING_WENT_WRONG_YOU_SHOULD_PANIK      = '9';
        }
    }
}